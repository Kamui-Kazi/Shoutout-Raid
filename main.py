...
#CLIENT_ID: str = "fpdfktk6qi0p9j2cg69ra3s7myk417" #creds.twitch_bot_client_id
#CLIENT_SECRET: str = "flfit0jzi4x6ksjlgodrzbitaqds0e" #creds.twitch_bot_client_secret

CLIENT_ID: str = creds.twitch_bot_client_id
CLIENT_SECRET: str = creds.twitch_bot_client_secret
BOT_ID = creds.bot_id
